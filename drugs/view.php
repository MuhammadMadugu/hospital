...
/* =========================
   Pagination Count
========================= */
$countSql   = "SELECT COUNT(*) AS total FROM drugs d $where";
...
<div class="card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h2>Drugs</h2>
        <a href="index.php" class="btn btn-primary">+ Add Drug</a>
    </div>
        ...
        <table class="table">
            ...
            <?php $i = $offset + 1; while ($row = $drugs->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="table-actions">
                        <a onclick="deleteDrug(<?= $row['id'] ?>)" class="delete-btn">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
