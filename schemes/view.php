...
/* =========================
   Pagination Count
========================= */
$countSql   = "SELECT COUNT(*) AS total FROM schemes $where";
...
<div class="card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h2>Schemes</h2>
        <a href="index.php" class="btn btn-primary">+ Add Scheme</a>
    </div>
    ...
    <div class="card-body" style="padding:24px;">
        ...
        <table class="table">
            ...
            <tbody>
            <?php $i = $offset + 1; while ($row = $schemes->fetch_assoc()): ?>
                <tr>
                    <td><?= $i++ ?></td>
                    <td><?= htmlspecialchars($row['name']) ?></td>
                    <td><strong><?= number_format($row['discount_fee'], 2) ?>%</strong></td>
                    <td class="table-actions">
                        <a href="index.php?id=<?= $row['id'] ?>">Edit</a>
                        <a onclick="deleteScheme(<?= $row['id'] ?>)" class="delete-btn">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
...
function deleteScheme(id) {
    swal("Are you sure?", "This scheme will be deleted.", "warning", {
