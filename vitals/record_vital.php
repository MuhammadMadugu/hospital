...
/* =========================
   HELPER FUNCTION FOR READABLE DATES
========================= */
...
if (!empty($search)) {
    $filterText .= " for search term: <strong>" . htmlspecialchars($search) . "</strong>";
}

// Default text if no filter
if ($filterText == "Appointments") {
        ...
        <table class="table">
            ...
            <?php $i = $offset + 1; while ($row = $appointments->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <?php  if($row['status'] == 0)
                                   echo '<span style="color:#e67e22;font-weight:600;">Sent to nurses</span>';
                               else if($row['status'] == 1)
                                   echo  '<span style="color:#0a7a0a;font-weight:600;">Sent to Doctor</span>' 
                        ?>

                    </td>
                    <td class="table-actions">
                        <a href="record_patient_vitals.php?id=<?=$row['id']?>" 
                           class="delete-btn">Record Vital</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
