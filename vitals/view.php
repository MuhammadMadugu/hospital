...
/* =========================
   Pagination Count
========================= */
$countSql   = "SELECT COUNT(*) AS total FROM vitals $where";
...
<div class="card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h2>Vitals List</h2>
        <a href="index.php" class="btn btn-primary">+ Add Vital</a>
    </div>
    ...
    <form action="" method="GET" class="search-form">
        ...
        <?php if ($vitals->num_rows == 0): ?>
            <p style="text-align:center;padding:30px;color:#777;">
                No vitals found for the search term.
            </p>
        <?php else: ?>
            <table class="table">
                <thead>
                ...
                <tbody>
                    <?php $i = $offset + 1; while($row = $vitals->fetch_assoc()): ?>
                        <tr>
                            <td><?= $i++ ?></td>
                            ...
                            <td class="table-actions">
                                ...
                                <a onclick="deleteVital(<?= $row['id'] ?>)" class="delete-btn">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
...
function deleteVital(id){
       ...
       swal("Are you sure?", "This vital will be deleted permanently.", "warning", {
