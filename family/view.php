...
/* =========================
   WHERE
========================= */
$where = "WHERE status=1"; // show all families, can filter by status if needed
...
/* =========================
   Pagination Count
========================= */
$countSql   = "SELECT COUNT(*) AS total FROM families $where";
...
<div class="card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h2>Families</h2>
        <a href="add.php" class="btn btn-primary">+ Add Family</a>
    </div>
    ...
    <div class="card-body" style="padding:24px;">
        ...
        <table class="table">
            ...
            <tbody>
            <?php $i = $offset + 1; while ($row = $families->fetch_assoc()): ?>
                <tr>
                    <td><?= $i++ ?></td>
                    ...
                    <td class="table-actions">
                        ...
                        <a onclick="deleteFamily(<?= $row['id'] ?>)" class="delete-btn">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
...
<script>
  function deleteFamily(id) {
    swal("Are you sure?", "This family will be removed.", "warning", {
