...
/* =========================
   Pagination Count
========================= */
$countSql   = "SELECT COUNT(*) AS total FROM specimen $where";
...
<head>
<meta charset="UTF-8">
<title><?= APP_NAME ?> | Lab Specimen</title>
...
<div class="card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h2>Specimens</h2>
        <a href="index.php" class="btn btn-primary">+ Add Specimen</a>
    </div>
    ...
    <div class="card-body" style="padding:24px;">
        ...
        <table class="table">
            ...
            <tbody>
            <?php $i = $offset + 1; while ($row = $specimens->fetch_assoc()): ?>
                <tr>
                    <td><?= $i++ ?></td>
                    ...
                    <td class="table-actions">
                        ...
                        <a onclick="deleteCategory(<?= $row['id'] ?>)" class="delete-btn">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
...
function deleteCategory(id) {
    swal("Are you sure?", "This specimen will be deleted.", "warning", {
